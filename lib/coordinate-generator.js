const CoordinateGenerator = (function () {
    ...
    function getArchimedeanSpiral(steps, rotations = 2, spiralTightness = 5, initialRadius = 50) {
        const coordinates = [];
        ...
        for (let i = 0; i < steps; i++) {
            ...
            if (stepsInSegment === segmentLength) {
                ...
                switch (direction) {
                    ...
                    case 'up': direction = 'left'; segmentLength++; break;
                    case 'left': direction = 'down'; break;
                    case 'down': direction = 'right'; segmentLength++; break;
                }
            }
        }
