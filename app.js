...
function build() {
    ...
    for (const block of blocks) {
        block.convertedColor = convertColor('#' + BlockMaker.convertColorToHex(block.color));
    }
    ...
    for (const block of blocks) {
        const material = new THREE.MeshPhongMaterial({ color: block.color, flatShading: true });
